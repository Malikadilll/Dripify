...
export default function HomeScreenBuyer({ navigation }) {
  ...
  useEffect(() => {
    ...
    if (searchText) {
      ...
      setSearchSuggestions(data.slice(0, 3));
    } else {
          ...
          Welcome to <Text style={styles.dripify}>Dripify</Text>
            ...
            <View style={{ marginTop: 16 }}>
              ...
              {featuredProducts.length > 0 ? (
                  ...
                  renderItem={({ item }) => (
                    ...
                    >
                      ...
                      <View style={styles.carouselOverlay}>
                        ...
                        <Text style={styles.carouselPrice}>${(item.price ?? 0).toFixed(2)}</Text>
                      </View>
                    </TouchableOpacity>
                  )}
                ...
                <Text style={{ paddingHorizontal: 4, color: '#666' }}>No featured products.</Text>
              )}
              
            </View>
              
              <BrandIcons/>
              <FlashSaleBanner duration={129859} />
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <TouchableOpacity onPress={() => navigation.navigate('BuyerProducts')}>
                <Text style={{ marginTop: 28 }}>See All</Text>
              </TouchableOpacity>
            </View>
          </View>
        }
...
messageIcon: {
  ...
  carouselCard: { width: SCREEN_WIDTH * 0.75, height: 160, borderRadius: 14, overflow: 'hidden', backgroundColor: '#eee' },
  carouselImage: { width: '100%', height: '100%', resizeMode: 'cover' },
  carouselOverlay: { position: 'absolute', bottom: 0, left: 0, right: 0, padding: 10, backgroundColor: 'rgba(0,0,0,0.35)' },
  carouselTitle: { color: '#fff', fontSize: 16, fontWeight: '600' },
  carouselPrice: { color: '#fff', marginTop: 4, fontSize: 14, fontWeight: '500' },
  categoryCard: { backgroundColor: '#fdfeffff', padding: 10, borderRadius: 10, alignItems: 'center', minWidth: 80, elevation: 1 },
